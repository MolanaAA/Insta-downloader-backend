...
const CONFIG = {
  ...
  USE_PROXIES: false,
  PROXY_LIST: [
    // Add your proxy list here if available
    // 'http://proxy1:port',
    // 'http://proxy2:port',
  ]
};

// Session store for maintaining cookies and sessions
...
// Utility function to get random proxy
...
app.post('/api/download', async (req, res) => {
  try {
    ...
    // Create download URL for the user
